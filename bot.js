...
client.on('ready', () => {
  client.user.setGame('^help l by ๖̶̶̶ζ͜͡¤💕7м̃̾ŏŏ#5526','https://www.twitch.tv/TEST-Broadcast');
  console.log('---------------');
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === '^inv') {
              message.channel.send('**الربط : :heart:https://discordapp.com/api/oauth2/authorize?client_id=501158685855186985&permissions=0&scope=bot :heart: **');
              message.channel.sendFile("./photoshop.PNG");
